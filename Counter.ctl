...
Attribute CharacterExtraX.VB_ProcData.VB_Invoke_Property = ";Darstellung"
...
Attribute PosnX.VB_ProcData.VB_Invoke_PropertyPut = ";Darstellung"
...
Attribute PosnY.VB_ProcData.VB_Invoke_PropertyPut = ";Darstellung"
...
Attribute CharacterExtraY.VB_ProcData.VB_Invoke_Property = ";Darstellung"
...
Public Property Set Font(ByVal nwFont As Font)
  ...
  Dim Dgt As String * 1
    ...
    For i = 0 To myDigits - 1                 'prepare pcDigit's
        ...
        End With 'PCDIGIT(I)
    Next i
    MinDelta = 1 / BoxHeight                'skip Display if Delta is less
...
Attribute Digits.VB_ProcData.VB_Invoke_Property = ";Darstellung"
...
Attribute Value.VB_ProcData.VB_Invoke_Property = ";Daten"
...
':) Ulli's VB Code Formatter V2.11.3 (11.04.2002 14:11:47) 29 + 337 = 366 Lines
